...
"        'conf.clustertype': 5,\n"
"        'conf.configfile': '/etc/cmon.d/cmon_1.cnf',\n"
...
UtS9sCluster::testAssign()
{
    ...
    S9S_COMPARE(theCluster.configFile(),   "/etc/cmon.d/cmon_1.cnf");
    S9S_COMPARE(theCluster.logFile(),      "/var/log/cmon_1.log");
...
UtS9sCluster::testToString()
{
    ...
    S9S_COMPARE(theString, "/etc/cmon.d/cmon_1.cnf /var/log/cmon_1.log");
    ...
    theString = theCluster.toString(false, "%3ccores %N");
    S9S_COMPARE(theString, " 40cores ft_postgresql_19203");
    
    theString = theCluster.toString(false, "%n %i");
    S9S_COMPARE(theString, "2 2");
    
    theString = theCluster.toString(false, "%.2k");
